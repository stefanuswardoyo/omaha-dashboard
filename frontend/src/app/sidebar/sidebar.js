...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-black  rounded">
      ...
      <a
        className="flex items-center justify-center w-full h-16 mt-auto bg-black hover:bg-gray-700 hover:text-gray-300"
        href="#"
      >
        <svg
